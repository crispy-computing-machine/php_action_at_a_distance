...
setlocal enableextensions enabledelayedexpansion
	...
	for %%z in (%ZTS_STATES%) do (
		...
		rem Shebang
		echo "Running tests..."
		"%APPVEYOR_BUILD_FOLDER%\build\php.exe" -d"extension_dir=%APPVEYOR_BUILD_FOLDER%\build\ext\" -d"extension=php_action_at_a_distance.dll" C:\projects\php-src\ext\action_at_a_distance\run-tests.php C:\projects\php-action-at-a-distance\tests\basic\
